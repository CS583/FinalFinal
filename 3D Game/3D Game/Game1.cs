      ...
      //   vidPlayer = new VideoPlayer();
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            if (currentGameState == GameState.PLAY)
            {
                ...
                string WeaponText = "ShipsLeft:" + modelManager.missesLeft;
                spriteBatch.DrawString(scoreFont, WeaponText,
                    new Vector2(135, (Window.ClientBounds.Height) - 175 + scoreFont.MeasureString(scoreText).Y),
                    Color.Red);

                //Let the player know how maney misses left
                spriteBatch.DrawString(scoreFont, "Missiles: \n"  +specialList
                    ,
                ...
                spriteBatch.DrawString(scoreFont, "Health: " +
                   (int)modelManager.playerHealth,
                    new Vector2(135, (Window.ClientBounds.Width) - 330 + scoreFont.MeasureString(scoreText).Y),
                    Color.Red);
